...
void Menu_Tick(void)
{
        ...
        case MenuPage_Opening:
        {
            ...
            else
            {
                ...
                switch (beat)
                {
                	...
                	Menu_DrawHealth(20, 86, 114, true);
                	Menu_DrawHealth(22, 202, 115, true);
    ...
    //Fallthrough
		...
		if(stage.prefs.bweek_awards ==true){wicon=11; fwt="Beaten Mind Games Full Week";}
		else{wicon=10; fwt="?";}
		...
		if(stage.prefs.udemo_awards ==true){udicon=17; udmt="Unlocked Mind Games Demo";}
		else{udicon=10; udmt="?";}
		
		if(stage.prefs.bdweek_awards ==true){bdwicon=12; bdwt="Beaten Mind Games Demo Week";}
		else{bdwicon=10; bdwt="?";}

		if(stage.prefs.flopg_awards ==true){fgicon=18; fgt="Unlocked Floppa Games";}
	 	else{fgicon=10; fgt="?";}
        ...
        case MenuPage_Freeplay:
        {
		    struct
		    {
		        ...
		        {StageId_2_3, 0x580093, "PSYCHIC", 2, 0, true},
		    };
        ...
        case MenuPage_Credits:
        {
            ...
            static const struct
            {
                ...
                {" ", 0, 6, 0xFF9b30f3},
                {" ", 0, 6, 0xFF9b30f3},
                {"nintendo bro", 12, 20, 0xFF51ffb3},
                {" ", 0, 6, 0xFF9b30f3},
                {" ", 0, 6, 0xFF9b30f3},
                {"ckdev" , 13, 21,0xFFc5f05f},
            };
