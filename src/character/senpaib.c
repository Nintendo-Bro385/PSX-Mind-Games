...
static const Animation char_senpaib_anim[PlayerAnim_Max] = {
	...
	{2, (const u8[]){ 13,  13, ASCR_BACK, 1}},   //CharAnim_DownAlt
	{2, (const u8[]){ 9,  10, ASCR_BACK, 1}},         //CharAnim_Up
	{2, (const u8[]){0,  0, ASCR_BACK, 1}},   //CharAnim_UpAlt
	{2, (const u8[]){11, 12, ASCR_BACK, 1}},         //CharAnim_Right
	{0, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},   //CharAnim_RightAlt

	{1, (const u8[]){ 5, 14, 14, 14, ASCR_BACK, 1}},     //PlayerAnim_LeftMiss
	{1, (const u8[]){ 7, 15, 15, 15, ASCR_BACK, 1}},     //PlayerAnim_DownMiss
	{1, (const u8[]){ 9, 16, 16, 16, ASCR_BACK, 1}},     //PlayerAnim_UpMiss
	{1, (const u8[]){11, 17, 17, 17, ASCR_BACK, 1}},     //PlayerAnim_RightMiss

	{0, (const u8[]){0,}},
	{0, (const u8[]){0,}},

	{5, (const u8[]){18, 19, 20, 21, 21, ASCR_CHGANI, PlayerAnim_Dead1}}, //PlayerAnim_Dead0
...
void Char_SenpaiB_Tick(Character *character)
{
    ...
    if (StageState_Dialogue && stage.delect <=14)
    {
    	character->set_anim(character, CharAnim_DownAlt);
    }
    if(StageState_Dialogue && stage.delect ==15)
    {
