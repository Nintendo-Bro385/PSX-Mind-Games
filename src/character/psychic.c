...
enum
{
	...
	Psychic_ArcMain_Upalt0,
	Psychic_ArcMain_Upalt1,
	Psychic_ArcMain_Upalt2,
	Psychic_ArcMain_Upalt3,
	Psychic_ArcMain_Upalt4,
	Psychic_ArcMain_Upalt5,
...
static const CharFrame char_psychic_frame[] = {
	{Psychic_ArcMain_Idle0, {  0,   0, 144, 228}, { 42, 195}}, //0 idle 1
	{Psychic_ArcMain_Idle1, {  0,   0, 142, 228}, { 42, 195}}, //1 idle 2
	{Psychic_ArcMain_Idle2, {  0,   0, 140, 228}, { 41, 195}}, //2 idle 3
	{Psychic_ArcMain_Idle3, {  0,   0, 139, 228}, { 41, 195}}, //3 idle 4
	{Psychic_ArcMain_Idle4, {  0,   0, 140, 228}, { 41, 195}}, //4
	{Psychic_ArcMain_Idle5, {  0,   0, 140, 228}, { 41, 195}}, //5
	...
	{Psychic_ArcMain_Upalt0,    {  0,   0, 162, 222}, { 60-23, 189}}, //24
	{Psychic_ArcMain_Upalt1,    {  0,   0, 162, 222}, { 60-23, 189}}, //25
	{Psychic_ArcMain_Upalt2,    {  0,   0, 162, 222}, { 60-23, 189}}, //26
	{Psychic_ArcMain_Upalt3,    {  0,   0, 162, 222}, { 60-23, 189}}, //27
	{Psychic_ArcMain_Upalt4,    {  0,   0, 162, 222}, { 60-23, 189}}, //28
	{Psychic_ArcMain_Upalt5,    {  0,   0, 162, 222}, { 60-23, 189}}, //29
...
static const Animation char_psychic_anim[PlayerAnim_Max] = {
	...
	{1, (const u8[]){ 24, 24, 25, 25, 26, 26, 27, 27, 27, 28, 28, 29, 29, 0, ASCR_BACK, 14}},   //CharAnim_UpAlt
...
void Char_Psychic_Tick(Character *character)
{
	...
	if (stage.flag & STAGE_FLAG_JUST_STEP)
	{
		...
		if (stage.note_scroll >= 0)
		{
			...
			{
				case StageId_1_1: //Tutorial peace
...
Character *Char_Psychic_New(fixed_t x, fixed_t y)
{
	...
	IO_Data *arc_ptr = &this->arc_ptr[Psychic_ArcMain_Idle0];
