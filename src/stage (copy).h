...
typedef struct
{
	...
	{
		//Stage settings
		boolean ghost, downscroll, botplay, lowquality, secretunlocked, expsync;
		int menumusic;
	...
	{
		//Stage settings
		boolean bweek, mweek, mpsy, mwilt, mup, dsu, udemo, flopg, debugger;
	}awards;
	...
	//HUD textures
	Gfx_Tex tex_hud0, tex_hud1, tex_hud2, tex_dia;
