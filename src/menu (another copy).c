...
static struct
{
    ...
    //Menu assets
    Gfx_Tex tex_back, tex_ng, tex_story, tex_title, tex_week, tex_back;
    IO_Data weeks, weeks_ptrs[128];
    IO_Data backg, backg_ptrs[16];
    int curweek;
    int curbackg;
...
static void CheckAndLoadBg(int week)
{
    if (menu.curbackg != week)
    {
        char backgtxt[20];
        sprintf(backgtxt, "back%d.tim", week);
        Gfx_LoadTex(&menu.tex_back, Archive_Find(menu.backg, backgtxt), 0);
        menu.curbackg = back;
    }
...
void Menu_Load(MenuPage page)
{
    ...
    menu.backg = IO_Read("\\MENU\\BACKG.ARC;1");
    Gfx_LoadTex(&menu.tex_back,  Archive_Find(menu_arc, "back0.tim"),  0);
    ...
    //Fallthrough
        ...
        case MenuPage_Story:
        {
            static const struct
            {
                ...
                {NULL, StageId_1_4, "TUTORIAL", {"TUTORIAL", NULL, NULL}, 0},
                {"1", StageId_1_1, "MIND GAMES", {"PSYCHIC", "WILTER", "UPROAR"}, 1},
                {"2", StageId_2_1, "SPOOKY MONTH", {"SPOOKEEZ", "SOUTH", "MONSTER"}, 0},
                {"3", StageId_3_1, "PICO", {"PICO", "PHILLY NICE", "BLAMMED"}, 0},
                {"4", StageId_4_1, "MOMMY MUST MURDER", {"SATIN PANTIES", "HIGH", "MILF"}, 0},
                {"5", StageId_5_1, "RED SNOW", {"COCOA", "EGGNOG", "WINTER HORRORLAND"}, 0},
                {"6", StageId_6_1, "HATING SIMULATOR", {"SENPAI", "ROSES", "THORNS"}, 0},
                {"7", StageId_7_1, "TANKMAN", {"UGH", "GUNS", "STRESS"}, 0},
            };
        ...
        case MenuPage_Freeplay:
        {
            static const struct
            {
                ...
                {StageId_1_1, 0x580093, "PSYCHIC", 2, 1},
                {StageId_1_2, 0x580093, "WILTER", 2, 2},
                {StageId_1_3, 0x580093, "UPROAR", 2, 3},
